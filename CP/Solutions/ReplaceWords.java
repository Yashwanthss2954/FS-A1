...
class Solution {
    ...
    String convert(String word, Tri t) {
        ...
        if (idx == 0) return word; // not found.
        if (!parent.terminal) return word; // partial match won't count
...
inst
col
keshav neilgogte society institute college
output=ke ne so inst col
case=3
input=2
jan
feb
...
c
d
abc def cat bat ant ball call doll
